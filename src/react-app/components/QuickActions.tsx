      ...
      <div className="space-y-3">
        {actions.map((action, index) => (
          <motion.button
            ...
            className={`w-full flex items-center space-x-4 p-4 bg-[#0D0F18]/30 hover:bg-[#2A2F42]/50 border border-white/5 hover:border-[#6A3DF4]/30 rounded-xl transition-all duration-200 group relative ${
